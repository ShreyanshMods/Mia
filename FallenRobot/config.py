class Config(object):
    ...
    DATABASE_URL = "psql 'postgres://avnadmin:AVNS_haQWrDRLapcFJYdR1_3@rosebot-raishreya2923-bd1e.f.aivencloud.com:27882/defaultdb?sslmode=require'"  # A sql database url from elephantsql.com
